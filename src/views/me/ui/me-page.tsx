      ...
      <div className="flex w-full max-w-4xl flex-1 gap-6 px-4 py-8">
        ...
        <div className="flex w-72 shrink-0 flex-col gap-6">
          ...
          <div className="glass flex flex-col items-center rounded-2xl p-8">
            ...
            <Badge variant="outline" className="mt-2 text-xs text-neon border-neon/30">
              {t("userId")}: #{user.id}
            </Badge>
          </div>
